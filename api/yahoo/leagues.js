...
module.exports = async (req, res) => {
  try {
    ...
    const gameKeys = q.game_keys || q.game_key || "";
    if (!gameKeys) {
      res.statusCode = 400;
      res.json({ error: "Missing game_keys param" });
      return;
    }
    ...
    const path = `/users;use_login=1/games;game_keys=${encodeURIComponent(gameKeys)}/leagues`;
    try {
